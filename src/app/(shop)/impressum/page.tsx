  ...
  return (
    <div className="container max-w-3xl section-pad">
      ...
      <div className="space-y-8 text-[15px] leading-relaxed text-foreground/90">
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Anbieter</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Vertreten durch</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Kontakt</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Registereintrag</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Umsatzsteuer-ID</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Haftung für Inhalte</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Haftung für Links</h2>
          <p>
        ...
        <section>
          <h2 className="display-title text-xl text-foreground">Urheberrecht</h2>
          <p>
