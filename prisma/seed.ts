...
async function main() {
  ...
  const [
    ...
    prisma.category.upsert({
      ...
      update: { name: "Weight Loss", description: "GLP-1- und GIP-Rezeptoragonisten zur Erforschung metabolischer Signalwege und Gewichtsregulation.", sortOrder: 1 },
      create: {
        name: "Weight Loss",
        slug: "weight-loss",
        description: "GLP-1- und GIP-Rezeptoragonisten zur Erforschung metabolischer Signalwege und Gewichtsregulation.",
        sortOrder: 1,
      },
    }),
    prisma.category.upsert({
      where: { slug: "recovery" },
      update: { name: "Recovery", description: "Peptide zur Erforschung von Gewebereparatur, Wundheilung und regenerativen Prozessen.", sortOrder: 2 },
      create: {
        name: "Recovery",
        slug: "recovery",
        description: "Peptide zur Erforschung von Gewebereparatur, Wundheilung und regenerativen Prozessen.",
        sortOrder: 2,
      },
    }),
    prisma.category.upsert({
      where: { slug: "anti-aging" },
      update: { name: "Anti-Aging", description: "Kupferpeptide und bioaktive Verbindungen zur Erforschung von Hautalterung und Zellregeneration.", sortOrder: 3 },
      create: {
        name: "Anti-Aging",
        slug: "anti-aging",
        description: "Kupferpeptide und bioaktive Verbindungen zur Erforschung von Hautalterung und Zellregeneration.",
        sortOrder: 3,
      },
    }),
    prisma.category.upsert({
      where: { slug: "growth-hormone" },
      update: { name: "Growth Hormone", description: "GHRH-Analoga und Secretagoga zur Erforschung der Wachstumshormon-Achse.", sortOrder: 4 },
      create: {
        name: "Growth Hormone",
        slug: "growth-hormone",
        description: "GHRH-Analoga und Secretagoga zur Erforschung der Wachstumshormon-Achse.",
        sortOrder: 4,
      },
    }),
    prisma.category.upsert({
      where: { slug: "longevity" },
      update: { name: "Longevity", description: "Coenzyme und Metabolite zur Erforschung zellulärer Energieproduktion und Alterungsprozesse.", sortOrder: 5 },
      create: {
        name: "Longevity",
        slug: "longevity",
        description: "Coenzyme und Metabolite zur Erforschung zellulärer Energieproduktion und Alterungsprozesse.",
        sortOrder: 5,
      },
    }),
    prisma.category.upsert({
      where: { slug: "cognitive" },
      update: { name: "Cognitive", description: "Neuropeptide zur Erforschung kognitiver Funktionen, Angstmodulation und neuronaler Plastizität.", sortOrder: 6 },
      create: {
        name: "Cognitive",
        slug: "cognitive",
        description: "Neuropeptide zur Erforschung kognitiver Funktionen, Angstmodulation und neuronaler Plastizität.",
        sortOrder: 6,
      },
    }),
    prisma.category.upsert({
      where: { slug: "sexual-health" },
      update: { name: "Sexual Health", description: "Melanocortin-Rezeptoragonisten zur Erforschung sexueller Dysfunktion und neuroendokriner Signalwege.", sortOrder: 7 },
      create: {
        name: "Sexual Health",
        slug: "sexual-health",
        description: "Melanocortin-Rezeptoragonisten zur Erforschung sexueller Dysfunktion und neuroendokriner Signalwege.",
        sortOrder: 7,
      },
    }),
  ]);
  ...
  await seedProduct({
    slug: "semaglutide",
    name: "Semaglutide",
    description: "Semaglutide ist ein langwirksamer GLP-1-Rezeptoragonist mit 31 Aminosäuren und einer C18-Fettsäure-Modifikation, die eine verlängerte Plasmahalbwertszeit ermöglicht. Das Peptid wird in der Forschung zur Untersuchung von Glukosehomöostase, Appetitregulation und kardiovaskulären Signalwegen eingesetzt.",
    shortDesc: "GLP-1-Rezeptoragonist mit verlängerter Halbwertszeit für metabolische Forschung.",
    sku: "CP-SEMA-5MG",
    priceInCents: 2500,
    categoryId: catWeightLoss.id,
    stock: 120,
  ...
  await seedProduct({
    slug: "bpc-157",
    name: "BPC-157",
    description: "Body Protection Compound-157 (BPC-157) ist ein Pentadecapeptid aus 15 Aminosäuren, das als partielle Sequenz des Body Protection Compound aus Magensaft isoliert wurde. BPC-157 wurde in zahlreichen In-vitro- und Tiermodellen umfassend erforscht, insbesondere in Bezug auf seine Rolle bei zellulären Signalwegen der Gewebereparatur und Wundheilung.",
  ...
  await seedProduct({
    slug: "ghk-cu",
    name: "GHK-Cu",
    description: "GHK-Cu (Kupferpeptid) ist ein natürlich vorkommendes Tripeptid-Kupfer-Komplex (Glycyl-L-Histidyl-L-Lysin:Kupfer), das in menschlichem Plasma, Speichel und Urin nachgewiesen wurde. In der Forschung wird GHK-Cu zur Untersuchung von Kollagensynthese, Hautregeneration, antioxidativen Mechanismen und Wundheilungsprozessen eingesetzt.",
    shortDesc: "Kupferpeptid-Komplex zur Erforschung von Kollagensynthese und Hautregeneration.",
    sku: "CP-GHKCU-50MG",
    priceInCents: 2800,
  ...
  await seedProduct({
    slug: "tesamorelin",
    name: "Tesamorelin",
    description: "Tesamorelin ist ein synthetisches GHRH-Analogon mit 44 Aminosäuren, das durch eine trans-3-Hexensäure-Modifikation am N-Terminus eine verbesserte Stabilität aufweist. Es wird in der Forschung zur Untersuchung der Wachstumshormon-Sekretion und der Regulation viszeraler Adipositas eingesetzt.",
  ...
  await seedProduct({
    slug: "selank",
    name: "Selank",
    description: "Selank ist ein synthetisches Heptapeptid, das als Analogon des natürlich vorkommenden Immunopeptids Tuftsin entwickelt wurde. Es wird in der Forschung zur Untersuchung anxiolytischer Mechanismen, kognitiver Funktionen und der Modulation von BDNF- und Serotonin-Signalwegen eingesetzt. Selank zeigt in vitro eine hohe Stabilität gegenüber enzymatischem Abbau.",
    shortDesc: "Heptapeptid-Analogon zur Erforschung kognitiver und anxiolytischer Signalwege.",
    sku: "CP-SELANK-10MG",
    priceInCents: 1800,
  ...
  await seedProduct({
    slug: "pt-141",
    name: "PT-141",
    description: "PT-141 (Bremelanotide) ist ein zyklisches Heptapeptid und Melanocortin-Rezeptoragonist, der primär an MC3R- und MC4R-Rezeptoren im zentralen Nervensystem bindet. Es wird in der Forschung zur Untersuchung neuroendokriner Signalwege im Zusammenhang mit sexueller Funktion und Melanocortin-Regulation eingesetzt.",
